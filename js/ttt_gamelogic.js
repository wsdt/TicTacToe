...
function vari() {
    ...
    sqr3 = document.getElementById('ttt_square3').innerHTML;
    sqr4 = document.getElementById('ttt_square4').innerHTML;
    sqr5 = document.getElementById('ttt_square5').innerHTML;
    sqr6 = document.getElementById('ttt_square6').innerHTML;
    sqr7 = document.getElementById('ttt_square7').innerHTML;
    sqr8 = document.getElementById('ttt_square8').innerHTML;
    sqr9 = document.getElementById('ttt_square9').innerHTML;
}
